...
var CHAIN_ID = 1;
var WalletLinkConnector = function(_AbstractConnector) {
        ...
        if (window.ethereum && window.ethereum.isCoinbaseWallet === true) {
          ...
          var _temp6 = function() {
            if (!_this3.walletLink) {
              return Promise.resolve(import("./dist-P6V5ENXI.js").then(function(m) {
                var _m$default;
...
//# sourceMappingURL=walletlink-connector.esm-PXJ4X3MT.js.map
