...
var PortisConnector = function(_AbstractConnector) {
  _inheritsLoose(PortisConnector2, _AbstractConnector);
  function PortisConnector2(_ref) {
    var _this;
    var dAppId = _ref.dAppId, networks = _ref.networks, _ref$config = _ref.config, config = _ref$config === void 0 ? {} : _ref$config;
    ...
    }) ? true ? invariant(false, "One or more unsupported networks " + networks) : invariant(false) : void 0;
  ...
  _proto.activate = function activate() {
    try {
      ...
      var _temp4 = function() {
        if (!_this3.portis) {
          return Promise.resolve(import("./umd-T6NFE53O.js").then(function(m) {
            var _m$default;
  ...
  _proto.changeNetwork = function changeNetwork(newNetwork, isGasRelayEnabled) {
    try {
      ...
      if (typeof newNetwork === "number") {
        !!!chainIdToNetwork[newNetwork] ? true ? invariant(false, "Invalid chainId " + newNetwork) : invariant(false) : void 0;
...
//# sourceMappingURL=portis-connector.esm-I5VGTNM7.js.map
